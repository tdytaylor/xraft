...
public class Service {
  ...
  private final ConcurrentMap<String, CommandRequest<?>> pendingCommands =
  ...
  private <T> void awaitResult(
      GroupConfigChangeTaskReference taskReference, CommandRequest<T> commandRequest) {
    try {
