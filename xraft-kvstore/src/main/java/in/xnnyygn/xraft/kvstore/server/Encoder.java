...
public class Encoder extends MessageToByteEncoder<Object> {
  ...
  protected void encode(ChannelHandlerContext ctx, Object msg, ByteBuf out) throws Exception {
    if (msg instanceof Success) {
      this.writeMessage(
          MessageConstants.MSG_TYPE_SUCCESS, Protos.Success.newBuilder().build(), out);
    } else if (msg instanceof Failure) {
      Failure failure = (Failure) msg;
      Protos.Failure protoFailure =
          Protos.Failure.newBuilder()
      ...
      Protos.AddNodeCommand protoCommand =
          Protos.AddNodeCommand.newBuilder()
      ...
      Protos.RemoveNodeCommand protoCommand =
      ...
      Protos.GetCommand protoGetCommand =
          Protos.GetCommand.newBuilder().setKey(command.getKey()).build();
      ...
      Protos.GetCommandResponse protoResponse =
          Protos.GetCommandResponse.newBuilder()
      ...
      Protos.SetCommand protoSetCommand =
          Protos.SetCommand.newBuilder()
