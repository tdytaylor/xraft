...
public abstract class AbstractSingleThreadStateMachine implements StateMachine {
  ...
  private static final Logger logger =
      LoggerFactory.getLogger(AbstractSingleThreadStateMachine.class);
    ...
    taskExecutor.submit(
        () -> {
          if (lastApplied >= readIndex) {
            ...
            logger.debug(
                "waiting for last applied index {} to reach read index {}", lastApplied, readIndex);
