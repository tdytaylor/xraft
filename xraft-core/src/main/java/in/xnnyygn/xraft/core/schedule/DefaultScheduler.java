...
public class DefaultScheduler implements Scheduler {
  ...
  public DefaultScheduler(
    ...
    scheduledExecutorService =
        Executors.newSingleThreadScheduledExecutor(r -> new Thread(r, "scheduler"));
  }
  ...
  public ElectionTimeout scheduleElectionTimeout(@Nonnull Runnable task) {
    ...
    int timeout =
        electionTimeoutRandom.nextInt(maxElectionTimeout - minElectionTimeout) + minElectionTimeout;
    ScheduledFuture<?> scheduledFuture =
