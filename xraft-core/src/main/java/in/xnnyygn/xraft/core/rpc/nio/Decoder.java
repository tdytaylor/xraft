  ...
  protected void decode(ChannelHandlerContext ctx, ByteBuf in, List<Object> out) throws Exception {
    ...
    switch (messageType) {
      ...
      case MessageConstants.MSG_TYPE_APPEND_ENTRIES_RPC:
        ...
        aeRpc.setEntries(
            protoAERpc.getEntriesList().stream()
                .map(
                    e ->
                        entryFactory.create(
                            e.getKind(), e.getIndex(), e.getTerm(), e.getCommand().toByteArray()))
      ...
      case MessageConstants.MSG_TYPE_INSTALL_SNAPSHOT_PRC:
        ...
        isRpc.setLastConfig(
            protoISRpc.getLastConfigList().stream()
      ...
      case MessageConstants.MSG_TYPE_INSTALL_SNAPSHOT_RESULT:
        Protos.InstallSnapshotResult protoISResult =
            Protos.InstallSnapshotResult.parseFrom(payload);
      ...
      case MessageConstants.MSG_TYPE_PRE_VOTE_RESULT:
        ...
        out.add(
            new PreVoteResult(protoPreVoteResult.getTerm(), protoPreVoteResult.getVoteGranted()));
        break;
    }
  }
}
