...
public interface Log {
  ...
  InstallSnapshotRpc createInstallSnapshotRpc(
   ...
   */
  AddNodeEntry appendEntryForAddNode(
   ...
   */
  RemoveNodeEntry appendEntryForRemoveNode(
   ...
   */
  AppendEntriesState appendEntriesFromLeader(
      int prevLogIndex, int prevLogTerm, List<Entry> entries);

  /**
   * Advance commit index.
   *
   * <p>The log entry with new commit index must be the same term as the one in parameter, otherwise
   * commit index will not change.
   *
   ...
   *
   * <ul>
   *   <li>apply the log entry
   *   <li>generate snapshot
   *   <li>apply snapshot
   * </ul>
   *
