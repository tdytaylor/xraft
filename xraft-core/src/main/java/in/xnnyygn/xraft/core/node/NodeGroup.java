...
class NodeGroup {
   ...
   * Find member by id.
   *
   * <p>Throw exception if member not found.
   *
   * @param id id
   ...
   *
   * <p>To get major match index in group, sort match indices and get the middle one. TODO add doc
   *
   * @return match index
   */
   ...
   *
   * <p>Self is not replication target.
   *
   ...
   * Update member list.
   *
   * <p>All replicating state will be dropped.
   *
   * @param endpoints endpoints
   */
